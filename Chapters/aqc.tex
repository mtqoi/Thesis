...
%\end{equation}
%which is easily calculated using the measured $\text{P}\left(a\right)$. The conditional entropy $\text{H}\left(X_A \given X_B\right)$ is calculated following the discussion beneath Eq.~\ref
