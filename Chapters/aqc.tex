...
From our experimental collaborators we received four datasets output from the experiment detailed in Sec.~\ref{sec:aqc_experiment}, with parameters detailed in Tab.~\ref{table:aqc_data_parameters}. Each of the datasets consisted of


\begin{table*}%[hb!p]
	\centering \ra{1.75}
	\begin{tabular*}{\textwidth}{@{\extracolsep{\stretch{1}}}  rr c rrrrr c rr }
	%\toprule
	% primary header
	\multicolumn{2}{c}{\textbf{Experiment}} &&
	\multicolumn{5}{c}{\textbf{QPSK amplitudes} $[\sqrt{\text{snu}}\,]$} &&
	\multicolumn{1}{c}{\textbf{Excess noise}} \\
%	\colrule
	\hline
