...
We plot $\ev*{\hat{s_-}^\dagger \hat{s_-}}$ under this linearization approach in Fig.~\ref{fig:phog_multimode_linearized}a, and $Q$ in Fig.~\ref{fig:phog_multimode_linearized}b. 
...
We see that the photon-number expectation evolves identically between mean-field and linearization approaches, while our linearization approach has now given us the ability to calculate $Q$ of mode $s_-$ as
...
We have shown that a $Q$ parameter close to the predicted maximum of $Q \approx -0.8$ is attainable under \MT{conditions}. %mention energy here too
