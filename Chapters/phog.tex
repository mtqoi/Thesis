...
\ddt \rho = - i \left[\hat{H}, \rho\right] + \gamma_1 \left[\mathcal{L}\left(\hat{a}\right) + \mathcal{L}\left(\hat{b}\right) + \sum_{j=0}^N \mathcal{L}\left(\hat{c}_0\right) \right] \rho
\end{equation}
...
\begin{figure}[htp]
\centering
\includegraphics{phog/bounce.png}
\caption{\label{fig:phog_bounce}}
\end{figure}
