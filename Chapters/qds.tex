...
\begin{figure}[htp]
\centering
\includegraphics{mismatches.png}
...
\begin{figure}[htp]
\centering
\includegraphics{qds_attacks.png}
...
\begin{figure}[htp]
\centering
\includegraphics{types_of_attack.png}
...
\begin{figure}[htp]
\centering
\includegraphics{bs1_attack.png}
...
\begin{figure}[htp]
\centering
\includegraphics{postselection_region.png}
...
\noindent and similarly for $e_2, e_3, e_4$ with updated limits of the $\theta$ integral. The $\mathcal{N}$ is identical to that from Eq.~\ref{eqn:perrps_deriv_2}.

The $\emph{a priori}$ state is likewise found by mixing Eq.~\ref{eqn:qdsps_aposteriori} over all quadrants, and thus $\pe\left(\Delta_r, \Delta_\theta\right)$ may be calculated via Eq.~\ref{eqn:qds_hpe}.


\MT{chat here about updating $L$ to include the effects of postselection}
