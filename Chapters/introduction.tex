...
\end{equation}
the middle terms of which describes the energy of a simple harmonic oscillator (with $\hbar = 1$). The position and momentum operators $\hat{x}, \hat{p}$ describe real and imaginary components of the complex phase $\hat{a}$ of the electric field.
...
\FloatBarrier
\subsection{Chain rule for entropies}
