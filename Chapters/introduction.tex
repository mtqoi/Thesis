...
\centering
\captionsetup{width=0.8\linewidth}
\includegraphics[draft=false, width=0.8\linewidth]{introduction/coherent}
...
\captionsetup{width=0.8\linewidth}
\centering
\includegraphics[width=0.8\linewidth, draft=false]{introduction/squeeze}
...
\centering
\captionsetup{width=0.8\linewidth}
\includegraphics[draft=false, width=0.6\linewidth]{introduction/photon_number_squeezed}
...
\centering
\captionsetup{width=0.8\linewidth}
\includegraphics[width=0.6\linewidth, draft=false]{introduction/beamsplitter}
...
\centering
\captionsetup{width=0.8\linewidth}
\includegraphics[draft=false, width=0.6\linewidth]{introduction/homodyne}
...
\centering
\captionsetup{width=0.8\linewidth}
\includegraphics[draft=false, width=0.8\linewidth]{introduction/binary_entropy}
