...
Finally, we note the recent work by An \emph{et. al.} \cite{An2019} which boasts an experiment with GHz clock rate, allowing for \MT{mention their achievements and how they do it.}
