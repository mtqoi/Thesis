...
\end{align}
where operators $\hat{H}^{\left(p, q\right)}, \hat{A}^{\left(p, q\right)}$ are, in general, operators acting on the remaining modes of the system.
...
\end{equation}
So, transforming back to our master equation in Lindblad form,
