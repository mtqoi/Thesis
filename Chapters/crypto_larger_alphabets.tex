...
\centering
\includegraphics[width=0.6\linewidth]{qds/npsk_alphabet}
\caption{\label{fig:appendix_npsk} \MT{TODO: add caption}}
\end{figure}
...
\captionsetup{width=0.8\linewidth}
\centering
\includegraphics[draft=false, width=0.6\linewidth]{qds/appendix_npsk_length.png}
