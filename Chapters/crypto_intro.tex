...
The existence of such algorithms which successfully solve the hard problem poses a threat to many commonly used cryptosystems %such as RSA, DSA and ECDHE 
