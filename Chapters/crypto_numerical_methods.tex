...
\noindent Enacting beamsplitter relation Eq.~\ref{eqn:intro_beamsplitter_fock} on $\rho_{\text{input}}$ and heterodyning on Charlie's mode we arrive at %\MT{ TODO: compare this to my MMA file for consistency} - it matches my mma file nicely 
