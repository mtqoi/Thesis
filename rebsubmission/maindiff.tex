...
\DIFaddbegin \DIFadd{Finally, we note that the QSS protocol presented in this section, in which both Bob and Charlie send coherent states to a central Alice, is intrinsically similar in its setup to twin-field QKD systems}\footnote{\DIFadd{I am grateful to S. Barnett for pointing this out.}} \DIFadd{which have recently been proposed in order to overcome the rate-loss bound for repeaterless QKD \mbox{%DIFAUXCMD
